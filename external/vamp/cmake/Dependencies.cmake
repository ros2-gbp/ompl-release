...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/../external/nigh")
  set(nigh_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/../external/nigh" CACHE INTERNAL "")
  message(STATUS "Using vendored nigh from ${nigh_SOURCE_DIR}")
else()
...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/../external/pdqsort")
  set(pdqsort_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/../external/pdqsort" CACHE INTERNAL "")
  message(STATUS "Using vendored pdqsort from ${pdqsort_SOURCE_DIR}")
else()
...
if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64")
  if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/../external/SIMDxorshift")
    set(SIMDxorshift_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/../external/SIMDxorshift" CACHE INTERNAL "")
    message(STATUS "Using vendored SIMDxorshift from ${SIMDxorshift_SOURCE_DIR}")
  else()
